...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolor/yolor-d6.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolor/models/yolor-d6.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='yolor/data/coco.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='yolor/data/hyp.finetune.1280.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=100)
    parser.add_argument('--batch-size', type=int, default=8, help='total batch size for all GPUs')
    parser.add_argument('--img-size', nargs='+', type=int, default=[544, 544], help='[train, test] image sizes')
    ...
    parser.add_argument('--name', default='exp544', help='save to project/name')
