...
if __name__ == '__main__':
    ...
    parser.add_argument('--hyp', type=str, default='yolor/data/hyp.finetune.mango.yaml', help='hyperparameters path')
    ...
    parser.add_argument('--name', default='exp768', help='save to project/name')
